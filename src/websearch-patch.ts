...
[ -z "$FACTORY_API_KEY" ] && export FACTORY_API_KEY="fk-droid-patch-skip-login"
[ -z "$FACTORY_DISABLE_KEYRING" ] && export FACTORY_DISABLE_KEYRING=1
"$DROID_BIN" "$@"
DROID_EXIT_CODE=$?
...
if not defined FACTORY_API_KEY set "FACTORY_API_KEY=fk-droid-patch-skip-login"
if not defined FACTORY_DISABLE_KEYRING set "FACTORY_DISABLE_KEYRING=1"
"%DROID_BIN%" %*
